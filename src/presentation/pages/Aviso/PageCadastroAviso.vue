...
import { RiArrowLeftLine, RiChatHistoryLine, RiSave3Line } from "@remixicon/vue";
import { useAvisosAdmin } from "@/presentation/composables/Aviso/useAvisosAdmin";

const router = useRouter();
const { criando, erro, sucesso, erroCampos, criar } = useAvisosAdmin();
...
async function aoSalvar() {
    ...
    try {
        ...
        limparFormulario();
        await router.push({ name: "AdministradorAvisos", query: { criado: "1" } });
    } catch {
        return;
    }
}
        ...
        <div class="container">
            ...
            <div class="mb-4 d-flex align-items-start gap-3 flex-wrap">
                ...
                <div class="flex-grow-1">
                    <h1 class="section-title">Cadastrar aviso</h1>
                    <p class="page-subtitle">
                        Publique um comunicado para os clientes. O aviso fica vinculado ao seu usuário
                        administrador e aparece na página pública <strong>/aviso</strong>.
                    </p>
                </div>
            </div>
            ...
            <div class="card admin-card border-0 shadow-sm">
                <div class="card-body p-4 p-md-5">
                    ...
                    <p class="admin-hint">
                        Preencha o título e a mensagem. O nome aceita até 80 caracteres.
                    </p>
                    <form class="row g-3" @submit.prevent="aoSalvar">
                        <div class="col-12">
                            <label class="form-label" for="cad-aviso-nome">Nome</label>
                            <input
                                id="cad-aviso-nome"
                                v-model="form.nome"
                                type="text"
                                ...
                                placeholder="Ex.: Comunicado de manutenção"
                        ...
                        <div class="col-12">
                            <label class="form-label" for="cad-aviso-descricao">Descrição</label>
                            <textarea
                                id="cad-aviso-descricao"
                                v-model="form.descricao"
                                rows="6"
                                class="form-control"
                                placeholder="Descreva o conteúdo do aviso para os clientes."
