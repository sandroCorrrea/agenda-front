...
watch(
  ...
  async (tipo) => {
    ...
    await carregarDestinatarios(tipo);
  }
);
...
async function salvar() {
  ...
  await router.push({ name: "AdministradorProtocolos", query: { criado: "1" } });
}
</script>
    ...
    <div class="container" style="max-width: 860px">
      ...
      <section class="hero mb-4">
        ...
        <div>
          ...
          <h1 class="title mb-2">Novo protocolo</h1>
          <p class="hero__sub mb-0">
            Organize entregas, endereços e destinatários com um fluxo claro e pronto para auditoria.
          </p>
        </div>
      </section>
      ...
      <div class="card border-0 shadow-sm proto-card">
        <div class="card-body p-4 p-md-5">
          <form class="row g-4" @submit.prevent="salvar">
            <div class="col-12">
            ...
            <div class="col-md-4">
              ...
              <select v-model="form.destinatario_tipo" class="form-select">
            ...
            <div class="col-12 d-flex justify-content-end gap-2 pt-2">
              ...
              <button class="btn btn-primary save-btn" :disabled="criando">
                <RiSave3Line class="me-1" />
                {{ criando ? "Salvando..." : "Salvar protocolo" }}
              </button>
            </div>
          </form>
        </div>
